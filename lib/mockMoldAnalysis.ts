...
const bumper: MoldAnalysisResult = {
  ...
  issues: [
    ...
    },
    {
      ...
      recommendation: 'Add internal stiffening ribs on the back of the splitter every ~150mm, OR thicken the splitter section from 2.5 → 3.2mm.',
      scoreImpact: '+9',
      beforeScore: 38,
      afterScore: 47,
    ...
    },
    {
      ...
      recommendation: 'Increase slat thickness from 1.6 → 2.4mm, OR run a higher-temp mold to delay the freeze-off behind each slat.',
      scoreImpact: '+5',
      beforeScore: 38,
      afterScore: 43,
    ...
    },
    {
      ...
      whyItMatters:
        'The 1.5mm light-bar cutout creates a localized thin section that hesitates during fill — risk of short-shot at the cutout when running cold.',
      ...
      recommendation: 'Bump local section to 1.8mm OR add a small dummy boss to keep flow moving through the area.',
      scoreImpact: '+4',
      beforeScore: 38,
      afterScore: 42,
